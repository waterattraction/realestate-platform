...
CREATE TABLE IF NOT EXISTS trust_asset_trust_marks (
    ...
    trust_marker        VARCHAR(64) NOT NULL DEFAULT '无标记',
    internal_status     VARCHAR(32) NOT NULL DEFAULT '正常',
    marker_note         TEXT,
    created_by          VARCHAR(64),
    updated_by          VARCHAR(64),
    created_at          TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    updated_at          TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    CONSTRAINT uq_trust_asset_trust_marks UNIQUE (trust_product_id, asset_code)
);
