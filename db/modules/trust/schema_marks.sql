...
CREATE TABLE IF NOT EXISTS trust_asset_trust_marks (
    ...
    CONSTRAINT uq_trust_asset_trust_marks UNIQUE (trust_product_id, custody_asset_code, data_date)
);

CREATE INDEX IF NOT EXISTS idx_trust_asset_trust_marks_lookup
    ON trust_asset_trust_marks (trust_product_id, custody_asset_code, data_date DESC);
